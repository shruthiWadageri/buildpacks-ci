...
def delete_space
  cf_delete_space_command = "cf delete-space #{cf_space} -f"
...
cf_space = "sample-app-#{Random.rand(100000)}"
...
cf_create_space_command = "cf create-space #{cf_space}"
cf_create_space_output = `#{cf_create_space_command}`
puts cf_create_space_output

cf_target_command = "cf target -o #{cf_organization} -s #{cf_space}"
